package cn.nj.storm.EJ2.examples.Chapter5.Item28;// List-based generic reduction with wildcard type - Page 136
...
public class Reduction
{
    ...
    public static void main(String[] args)
    {
        ...
        List<Double> doubleList = Arrays.asList(2.718281828, 3.141592654, 1.61803399);
